...
11. [投稿模板](#十一投稿模板)
12. [行為準則](#十二行為準則)
13. [附錄 A：常用來源資源](#附錄-a常用來源資源)
14. [附錄 B：變更紀錄](#附錄-b變更紀錄)
...
kinkref.org 是一個 **學術文獻轉譯站**，不是社群論壇，不是實踐指南站，不是任何個人或組織的宣傳管道。

站上的內容是：
- BDSM 相關英文學術文獻的中文摘要與索引
- BDSM 術語的學術溯源定義
- 學術書目的策展評介
...
如果你不想建立 GitHub 帳號，可以使用站主的 **投稿信箱**（見網站 Contact 頁）以電子郵件提交。
...
*CONTRIBUTING.md v1.1 — 靈範師 (Muse) 草擬，2026-05-02*
