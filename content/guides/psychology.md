...
audience: beginners
title_zh: BDSM 與心理學
title_en: BDSM and Psychology
tagline: 去病理化、意識狀態、依附理論 — BDSM 的心理學面貌
estimated_reading_time_min: 15
lead_paragraph: |
  你可能搜尋了「BDSM 心理學」「BDSM 精神疾病」「SM 變態心理學」或「BDSM 諮商」——不管是因為自己的傾向、伴侶的傾向、還是單純的知識好奇。這份指南為想認真理解 BDSM 心理學面向的一般讀者而寫，不預設你有臨床背景，也不預設你是新手（如果你剛開始接觸 BDSM，建議先看新手入門指南）。

  學術文獻在這個問題上的結論高度一致：BDSM 實踐者的心理健康水準不劣於一般人。Wismeijer & van Assen（2013）以 902 位實踐者與 434 位對照組比較，發現實踐者在多項人格與幸福感指標上表現相當甚至更佳；Richters 等人（2008）以澳洲全國代表性樣本確認了相同方向的結果；Brown、Barker & Rahman（2020）的系統性回顧涵蓋 60 篇研究，結論再次收斂——BDSM 傾向本身不是病理指標。但這不是說「BDSM 零風險」——任何涉及身體與心理強度的活動都需要知情合意與安全框架。重點是：BDSM 傾向本身不是精神疾病，DSM-5 已明確區分「性偏好」與「性偏好障礙症」。

  本站的策展立場是「合意至上，不訂定模範」（§6.11）。我們不判定任何動機來源的正確性，也不為特定實踐方式背書。以下六個主題區塊整理了從去病理化歷史到本土研究的核心文獻——你可以按自己的關注點選讀，不需要從頭到尾。

faq:
  - question: BDSM 是精神疾病嗎？
    answer: |
      DSM-5（精神疾病診斷與統計手冊第五版）明確區分了 paraphilia（性偏好）與 paraphilic disorder（性偏好障礙症）。單純對 BDSM 活動的興趣或實踐屬於前者，不構成精神疾病診斷。只有當性偏好導致當事人顯著痛苦（非來自社會排斥的痛苦）或對非合意者造成傷害時，才進入障礙症的範疇。Wismeijer & van Assen（2013）的大樣本研究與 Richters 等人（2008）的全國代表性樣本調查均支持這一立場。詳細的分類框架可參見本站的 [DSM 與性偏好分類](/glossary/dsm-paraphilia) 條目。
...
clusters:
  - cluster_title: 去病理化：歷史與證據
    cluster_lead: |
      「BDSM 是精神疾病嗎？」這個問題的學術答案不是一句「不是」——而是一段從 1886 年 Krafft-Ebing 的病理化開始、到 DSM-5 區分「偏好 vs 障礙」的百年演變。以下文獻記錄了這段歷程。
    entries:
      - type: books
        slug: krafft-ebing-psychopathia-sexualis
        why_in_this_cluster: 1886 年病理化起源——性學史上將 SM 首次歸類為精神病理的經典文本
      - type: glossary
        slug: dsm-paraphilia
        why_in_this_cluster: DSM-5 的關鍵區分——paraphilia vs paraphilic disorder
      - type: bibliography
        slug: moser-kleinplatz-2006
        why_in_this_cluster: DSM 改革倡議——推動將合意 BDSM 去病理化的學術論述
      - type: bibliography
        slug: wismeijer-2013
        why_in_this_cluster: 去病理化的基礎實證——大樣本比較研究的 anchor paper
      - type: bibliography
        slug: richters-2008
        why_in_this_cluster: 全國代表性樣本——澳洲全國調查中的 BDSM 心理健康數據

  - cluster_title: 心理特質研究
    cluster_lead: |
      「BDSM 實踐者在心理上跟一般人有什麼不同？」大規模研究的一致結論：在人格、心理健康、關係品質上不劣於或優於一般人。以下是核心實證。
    entries:
      - type: bibliography
        slug: connolly-2006
        why_in_this_cluster: 7 種標準化心理量表——早期心理特質全面評估
      - type: bibliography
        slug: cross-matheson-2006
        why_in_this_cluster: 四種病理化假說的實證檢驗——全部不被支持
      - type: bibliography
        slug: brown-barker-rahman-2020
        why_in_this_cluster: 60 篇研究的系統性回顧——心理健康文獻最完整的彙整
      - type: bibliography
        slug: lecuona-2025
        why_in_this_cluster: Wismeijer 複製研究（n=1884）——十年後的再驗證

  - cluster_title: 神經科學與意識狀態
    cluster_lead: |
      「subspace 是真的嗎？」是的——Sagarin Lab 的神經內分泌研究證實了 BDSM 場景中的荷爾蒙變化與意識狀態變異。top 和 bottom 的體驗在神經層面質性不同。
    entries:
      - type: bibliography
        slug: sagarin-2009
        why_in_this_cluster: cortisol 與 testosterone 的場景前後變化——神經內分泌基礎
      - type: bibliography
        slug: lee-2016
        why_in_this_cluster: BDSM 與極端儀式的變異意識狀態比較
      - type: bibliography
        slug: ambler-2017
        why_in_this_cluster: 角色特異的意識狀態——top=flow，bottom=transient hypofrontality
      - type: bibliography
        slug: wuyts-morrens-2022
        why_in_this_cluster: BDSM 生物學的系統性回顧
      - type: glossary
        slug: subspace
        why_in_this_cluster: bottom 的意識狀態變異——術語定義與圈內用法
      - type: glossary
        slug: topspace
        why_in_this_cluster: top 的心流狀態——術語定義與圈內用法

  - cluster_title: 合意文化與社會心理
    cluster_lead: |
      BDSM 社群發展出的合意文化（consent culture）不只是自我保護——學術研究發現，BDSM 實踐者在強暴迷思接受度、受害者歸責等量表上顯著低於對照組。合意框架本身值得主流社會學習。
    entries:
      - type: bibliography
        slug: klement-2017-consent-culture
        why_in_this_cluster: BDSM 社群的 rape-supportive attitudes 顯著低於對照組
      - type: bibliography
        slug: dunkley-brotto-2020
        why_in_this_cluster: BDSM 合意研究的綜合回顧
      - type: bibliography
        slug: bezreh-2012
        why_in_this_cluster: 揭露（disclosure）與污名——BDSM 實踐者的社會心理壓力
      - type: glossary
        slug: ssc
        why_in_this_cluster: 安全、理智、合意——最早的合意框架
      - type: glossary
        slug: rack
        why_in_this_cluster: 共知風險的合意 Kink——進階合意框架

  - cluster_title: Kink-aware 治療
    cluster_lead: |
      如果你是 BDSM 實踐者想找心理師，或你是心理師想理解 BDSM 個案——這兩篇是入門必讀。核心區分：kink-aware（理解 BDSM 是有效實踐）vs kink-friendly（友善但不一定理解）。
    entries:
      - type: bibliography
        slug: dunkley-brotto-2018
        why_in_this_cluster: kink-aware therapy 的基礎回顧——治療師素養的學術框架
      - type: bibliography
        slug: sprott-2021
        why_in_this_cluster: kink-sex 的 7 個主題——臨床工作者的實務參考

  - cluster_title: 跨文化與中文圈本土研究
    cluster_lead: |
      西方學術研究佔 BDSM 心理學的絕大多數。但中國和台灣的本土研究正在累積——中科院心理所、台灣性學研究的論文提供了非西方視角的重要 baseline。
    entries:
      - type: bibliography
        slug: liang-zhang-2023
        why_in_this_cluster: 中國 51 人質性研究——非西方脈絡的 BDSM 實踐經驗
      - type: bibliography
        slug: li-2024
        why_in_this_cluster: 中國大樣本（n=3310）——依附風格與 BDSM 傾向的關聯
      - type: bibliography
        slug: yang-li-2021
        why_in_this_cluster: 台灣 BDSM 認同建構——本土社群的身分協商歷程
      - type: bibliography
        slug: larva-rantala-2024
        why_in_this_cluster: 演化心理學視角——跨文化的理論框架

related_guides:
  - beginners
  - bdsmtest-interpretation
  - researchers
